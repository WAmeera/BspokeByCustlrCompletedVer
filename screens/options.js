...
export default class Options extends React.Component {
  ...
  //line 18-24 receive data of item previously send to this current screen
  //line 27-43 function to send items to the next screen, for these parts, it is send to the standard sizing screen
  //line 45-61 function to send items to the next screen, for these parts, it is send to the user own measurement screen
  render() {
